...
async function main(): Promise<void> {
  ...
  const ok = powerups >= 3 && cosmeticOffers >= 6 && cosmetics >= 8 && seasonPass >= 1 && activeSeason === 1;
  console.log(JSON.stringify({ ok, powerups, cosmeticOffers, cosmetics, seasonPass, activeSeason }));
