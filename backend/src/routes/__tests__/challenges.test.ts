...
// POST /challenges/:id/progress was removed (security: client-authoritative XP farming).
// Challenge progress is server-side only, tracked by GameOrchestrator at game-over.
